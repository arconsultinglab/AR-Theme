...
<head>
  ...
  <link rel="canonical" href="https://staging.arconsultinglabs.com/">
...
<div class="travel-hero-bg absolute col-12">
    <amp-img class="travel-hero-bg-img absolute" src="../img/travel/hero-2.jpg" height="80vmax" noloading=""></amp-img>
    <amp-img class="travel-hero-bg-img absolute" src="../img/travel/hero-3.jpg" height="80vmax" noloading=""></amp-img>
    <amp-img class="travel-hero-bg-img absolute" src="../img/travel/hero-1.jpg" height="80vmax" noloading=""></amp-img>
</div>
...
<section class="travel-discover py4 mb3 relative xs-hide sm-hide">
  <div class="max-width-3 mx-auto px1 md-px2">
    <div class="flex justify-between items-center">
      <header>
        <h2 class="travel-discover-heading bold line-height-2 xs-hide sm-hide">Discover<br class="md-hide lg-hide"> Adventures</h2>
        <div class="travel-discover-subheading h2 xs-hide sm-hide">Get inspired and find your next big trip</div>
      </header>

      <div class="travel-discover-panel travel-shadow-hover px3 py2 ml1 mr3 myn3 xs-hide sm-hide">
        <div class="bold h2 line-height-2 my1">From the blog</div>
        ...
        <p class="my1">
          <a class="travel-link" href="#">Read more</a>
        </p>
      </div>
    </div>
  </div>
...
<section class="travel-popular pb4 pt3 relative">
  <header class="max-width-3 mx-auto px1 md-px2">
    <h3 class="h1 bold line-height-2 md-hide lg-hide" aria-hidden="true">Top Adventures<br>Near You</h3>
    <h3 class="h1 bold line-height-2 xs-hide sm-hide center">Top Adventures Near You</h3>
  </header>
  <div class="overflow-scroll">
    <div class="travel-overflow-container">
...
<!--/ Like Button -->
          ...
          <div class="h2 line-height-2 mb1">
            <span class="travel-results-result-text">Surf Day. Board and Wetsuits Included in Price!</span>
            <span class="travel-results-result-subtext h3">&bull;</span>
            <span class="travel-results-result-subtext h3">$&nbsp;</span><span class="black bold">100</span>
          </div>
          ...
          <div class="h4 line-height-2">
            ...
            <span class="travel-results-result-subtext mr1">241 Reviews</span>
        ...
        <div class="m1 mt3 mb2">
          <div class="travel-results-result relative mb1">
            <div class="relative travel-results-result">
              <a class="travel-results-result-link block relative" href="#">
                <amp-img class="block rounded" width="346" height="200" noloading="" src="../img/travel/activity/discover-electronic-scene.jpg" srcset="../img/travel/activity/discover-electronic-scene@2x.jpg 2x, ../img/travel/activity/discover-electronic-scene.jpg 1x"></amp-img>
              </a>
...
<!--/ Like Button -->
          ...
          <div class="h2 line-height-2 mb1">
            <span class="travel-results-result-text">Discover Oaxaca&#39;s Electronic Music Scene with a Top DJ</span>
            <span class="travel-results-result-subtext h3">&bull;</span>
            <span class="travel-results-result-subtext h3">$&nbsp;</span><span class="black bold">113</span>
          </div>
          ...
          <div class="h4 line-height-2">
            ...
            <span class="travel-results-result-subtext mr1">42 Reviews</span>
            <span class="travel-results-result-subtext"><svg class="travel-icon" viewbox="0 0 77 100"><g fill="none" fill-rule="evenodd"><path stroke="currentColor" stroke-width="7.5" d="M38.794 93.248C58.264 67.825 68 49.692 68 38.848 68 22.365 54.57 9 38 9S8 22.364 8 38.85c0 10.842 9.735 28.975 29.206 54.398a1 1 0 0 0 1.588 0z"></path><circle cx="38" cy="39" r="10" fill="currentColor"></circle></g></svg> Oaxaca</span>
          </div>
        </div>
        <div class="m1 mt3 mb2">
          <div class="travel-popular-tilt-left mb1">
            <div class="relative travel-results-result">
              <a class="travel-results-result-link block relative" href="#">
                <amp-img class="block rounded" width="346" height="200" noloading="" src="../../img/travel/activity/skateboard-around-city.jpg" srcset="../../img/travel/activity/skateboard-around-city@2x.jpg 2x, ../../img/travel/activity/skateboard-around-city.jpg 1x"></amp-img>
              </a>
              <div class="travel-results-result-like absolute top-0 right-0">
                <div class="p1">
...
<!--/ Like Button -->
          ...
          <div class="h2 line-height-2 mb1">
            <span class="travel-results-result-text">Skateboard Around the City</span>
            <span class="travel-results-result-subtext h3">&bull;</span>
            <span class="travel-results-result-subtext h3">$&nbsp;</span><span class="black bold">92</span>
          </div>
          ...
          <div class="h4 line-height-2">
            ...
            <span class="travel-results-result-subtext mr1">17 Reviews</span>
...
<section class="travel-featured pt3 relative clearfix">
  <header class="max-width-2 mx-auto px1 md-px2 relative">
    <h3 class="travel-featured-heading h1 bold line-height-2 mb2 center">Featured Destinations</h3>
  </header>
...
<section class="travel-discover-mobile max-width-3 mx-auto py3 px1 md-hide lg-hide">
  <header>
    <h2 class="h1 bold line-height-2">Discover Adventures</h2>
    <div class="travel-discover-subheading h3">Get inspired and find your next big trip</div>
  </header>
  <div class="flex md-mx2 my3 py2 items-center travel-discover-panel travel-shadow-hover">
    ...
    <div class="flex-auto">
      <div class="h3 bold line-height-2 mb1">From the blog</div>
      <p class="travel-discover-panel-subheading my1">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit amet dolor set. <a class="travel-link" href="#">Read more</a>
      </p>
    </div>
  </div>
</section>
